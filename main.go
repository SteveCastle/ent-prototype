...
// QueryCars gets a list of cars from their edge with a user
...
// QueryUser will get a list of users.
...
func main() {
	...
	if err != nil {
		log.Fatalf("failed to create cars and a user: %v", err)
	}
